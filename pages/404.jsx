...
export default function NotFound() {
  return (
    <>
      <div className="min-w-screen min-h-screen bg-accent flex items-center p-5 lg:p-20 overflow-hidden relative">
        <div className="flex-1 min-h-full min-w-full rounded-3xl bg-primary shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
          <div className="w-full md:w-1/2">
            <div className="mb-10 lg:mb-20">
            </div>
            <div className="mb-10 md:mb-20 text-gray-600 font-light">
              <h1 className="font-black uppercase text-3xl lg:text-5xl text-accent mb-10">
                You seem to be lost!
              </h1>
              <p className="text-gray-400">The page you&apos;re looking for isn&apos;t available.</p>
