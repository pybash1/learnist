    ...
    <footer class="text-white">
      <div class="max-w-screen-xl px-4 pt-32 pb-12 mx-auto sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto text-center">
          <p class="text-4xl font-extrabold sm:text-6xl bg-clip-text bg-gradient-to-r from-accent/100 to-accent/50 text-transparent">
            Want to Try?
          </p>
            
          <a
            class="inline-block px-12 py-3 mt-8 text-sm font-medium border rounded-full border-white/25 hover:bg-white hover:text-accent"
            href="/onboarding"
          >
            Get Started
          </a>
        ...
        <div class="pt-12 mt-32 border-t border-white/25 sm:items-center sm:justify-between sm:flex">
          ...
          <div class="flex justify-center mt-6 space-x-6 sm:justify-end sm:mt-0">
            <a
              class="p-2 border rounded-full border-white/25 hover:text-accent"
              href=""
              target="_blank"
              rel="noreferrer"
            >
